      ...
      <div className="hidden lg:flex flex-1 flex-col justify-between p-12 bg-muted/30 border-r border-white/5 relative z-10">
        ...
        <div className="max-w-md">
          <div className="flex items-center gap-3 mb-8">
            ...
            <span className="font-display font-bold text-2xl gradient-text">SECURESHIELD AI</span>
          </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 relative z-10">
        ...
        >
          <div className="lg:hidden text-center mb-12">
            ...
            <h1 className="font-display font-bold text-3xl gradient-text">SECURESHIELD AI</h1>
          </div>
