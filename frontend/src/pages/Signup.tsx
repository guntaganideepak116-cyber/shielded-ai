...
const SignupPage = () => {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(error.message || 'Initialization sequence interrupted.');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="hidden lg:flex flex-1 flex-col justify-between p-16 bg-black/20 border-r border-white/5 relative z-10">
        <div>
          ...
          >
            ...
            <span className="font-display font-black text-2xl tracking-tighter gradient-text">SECURESHIELD AI</span>
          </motion.div>
        </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 relative z-10">
        ...
        >
          ...
          <div className="lg:hidden text-center mb-10">
            ...
            <h1 className="font-display font-black text-3xl gradient-text tracking-tighter">SECURESHIELD AI</h1>
          </div>
