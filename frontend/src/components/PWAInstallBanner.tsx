      ...
      {showBanner && (
        ...
        >
          <div className="container mx-auto max-w-lg pointer-events-auto">
            <div className="glass-card-strong neon-border p-4 flex items-center gap-4 relative overflow-hidden group">
              {/* Background accent */}
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  <h3 className="font-display font-bold text-sm text-white leading-tight">Install SecureWeb AI</h3>
                  <Sparkles className="w-3 h-3 text-primary animate-pulse" />
                </div>
                <p className="text-[11px] text-muted-foreground font-body mt-0.5 line-clamp-1">
                  Add to home screen for real-time protection & offline reports.
                </p>
              </div>
              ...
              <div className="flex items-center gap-2 shrink-0">
                <Button 
                  ...
                  className="gradient-btn h-9 text-[11px] font-bold px-4"
                >
